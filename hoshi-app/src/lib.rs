...
use crate::commands::content::{get_trending, get_home_content, get_content, get_content_by_cid, get_relation_tree, update_content, search, get_content_items, play_content_by_number, add_tracker_mapping, add_extension_source, update_extension_mapping, update_tracker_mapping, delete_tracker_mapping, search_extension};
...
pub fn run_inner() -> anyhow::Result<()> {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_trending, get_home_content, get_content, get_content_by_cid, update_content, search, get_relation_tree, get_content_items, play_content_by_number, add_tracker_mapping, add_extension_source, update_extension_mapping, update_tracker_mapping, delete_tracker_mapping, search_extension,
            get_schedule,
